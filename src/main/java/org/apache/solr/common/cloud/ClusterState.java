...
public class ClusterState implements JSONWriter.Writable {
  ...
  public static ClusterState load(SolrZkClient zkClient, Set<String> liveNodes) throws KeeperException, InterruptedException {
    ...
    // BEGIN FIX
    return new Solr9ClusterState(zkClient, liveNodes).buildClusterState();
  ...
  public static ClusterState load(Integer version, byte[] bytes, Set<String> liveNodes) {
    throw new UnsupportedOperationException("Use Solr9ClusterState to build ClusterState from ZK data");
...
//
  ...
  // FIX: Open up visibility if needed elsewhere
  static DocCollection collectionFromObjects(String name, Map<String,Object> objs) {
